...
\begin{frame}{Vive la experiencia}
    \centering
    \only<1>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/full_teams.jpg}}
    \only<2>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/start.jpg}}
    \only<3>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/starting_work.jpg}}
    \only<4>{
        \begin{columns}\begin{column}{0.50\textwidth}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/hard_party.png}
        \end{column}\begin{column}{0.50\textwidth}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/hard_beer.jpg}
        \end{column}\end{columns}
    }
    \only<5>{
        \begin{columns}\begin{column}{0.50\textwidth}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/como_puedas.jpg}
        \end{column}\begin{column}{0.50\textwidth}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/pestanas.jpg}
        \end{column}\end{columns}
    }
    \only<6>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/eating.jpg}}
    \only<7>{
        \begin{columns}\begin{column}{0.50\textwidth}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/duerme0.jpg}
        \end{column}\begin{column}{0.50\textwidth}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/duerme1.jpg}
        \end{column}\end{columns}
    }
    \only<8>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/working.jpg}}
    \only<9>{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{imgs/nyan.jpg}}
    \only<10>{
        \movie[width=\textwidth,
	       externalviewer]
	       {\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{videos/uploading.png}}
